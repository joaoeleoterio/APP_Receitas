    ...
    <div className="search-bar">
      ...
      <button
        ...
        onClick={ async () => {
          ...
          switch (searchType) {
          case 'ingredient':
            url = `https://www.themealdb.com/api/json/v1/1/filter.php?i=${inpSearch}`;
            break;
          case 'name':
            url = `https://www.themealdb.com/api/json/v1/1/search.php?s=${inpSearch}`;
            break;
          default:
            url = `https://www.themealdb.com/api/json/v1/1/search.php?f=${inpSearch}`;
          }
